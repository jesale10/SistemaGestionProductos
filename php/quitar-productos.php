...
<head>
  ...
  <!-- Personal CSS -->
  <link rel="stylesheet" href="../css/quitar-productos.css">
  ...
  <section class="sidebar">
    <div class="d-flex flex-column flex-shrink-1 p-2 bg-light sidebar">
      ...
      <ul class="nav nav-pills flex-column mt-2 h5">
        ...
        <li class="nav-item mb-2">
          <a href="crear-pedido.php" class="nav-link link-dark">
        ...
        <li class="nav-item mb-2">
          <a href="quitar-productos.php" class="nav-link active">

  ...
  <section class="sidebar">
    <div class="d-flex flex-column flex-shrink-1 p-2 bg-light sidebar">
      ...
      <ul class="nav nav-pills flex-column mt-2 h5">
        ...
        <li class="nav-item mb-2">
          <a href="php/crear-pedido.php" class="nav-link link-dark">
          <i class="bi bi-cart-plus"></i>
            Crear Pedido
          </a>
        </li>
        <li class="nav-item mb-2">
          <a href="php/generar-factura.php" class="nav-link link-dark">
          <i class="bi bi-calendar2-check"></i>
            Generar Factura
          </a>
        </li>
        <li class="nav-item mb-2">
          <a href="php/facturas.php" class="nav-link link-dark">
          <i class="bi bi-calendar3"></i>
            Facturas
          </a>
        </li>
        <li class="nav-item mb-2">
          <a href="php/productos.php" class="nav-link link-dark">
          <i class="bi bi-bag"></i>
            Productos
          </a>
        </li>
        ...
        <li class="nav-item mb-2">
          <a href="php/entregar-pedidos.php" class="nav-link link-dark">
